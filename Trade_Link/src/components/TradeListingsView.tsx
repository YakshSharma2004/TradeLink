...
export function TradeListingsView({
  ...
  return (
    <div className="min-h-screen bg-slate-50 animate-fade-in">
      {/* Header */}
      <header className="bg-gradient-warm border-b border-orange-300/50 sticky top-0 z-10 shadow-construction">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <Button variant="secondary" onClick={onBack} className="mb-2 hover-lift">
            <ArrowLeft className="mr-2 h-4 w-4" />
            Back to Dashboard
          </Button>
          <div className="flex items-center justify-between">
            <div className="animate-slide-up">
              <h1 className="text-3xl font-bold text-white drop-shadow-md">{tradeType}</h1>
            ...
            <div className="text-right animate-slide-up animate-delay-100">
              <p className="text-sm text-white/80">Average Rate</p>
              <p className="text-3xl font-bold text-white drop-shadow-md">${averageRate}</p>
            </div>
          </div>
        </div>
      </header>
